...
<div class="head">
    <div class="wrapper clearfix">
        <div class="clearfix" id="top"><h1 class="fl"><a href="index.html"><img src="img/logo.png"/></a></h1>
            <div class="fr clearfix" id="top1"><p class="fl"><a href="#" id="login">登录</a><a href="#" id="reg">注册</a>
                ...
                <form action="#" method="get" class="fl"><input type="text" placeholder="搜索"/><input
                        type="button"/></form>
                <div class="btn fl clearfix"><a href="mygxin.html"><img src="img/grzx.png"/></a></a><a href="cart.html"><img src="img/gwc.png"/></a>
        ...
        <ul class="clearfix" id="bott">
            ...
            <li><a href="flowerDer.html">学习相关</a>
                <div class="sList2">
                    <div class="clearfix"><a href="proList.html">学习书籍</a><a href="vase_proList.html">作业指导</a></div>
                </div>
            </li>
            <li><a href="decoration.html">生活用品</a>
                <div class="sList2">
                    <div class="clearfix"><a href="zbproList.html">二手好货</a><a href="bzproList.html">电子设备</a></div>
                </div>
            </li>
            <li><a href="paint.html">小食分享</a></li>
            <li><a href="perfume.html">二次元相关</a></li>
            <li><a href="idea.html">其他</a></li>
        </ul>
    </div>
</div><!-------------------------banner--------------------------->
