				...
				<table class="result-tab" width="100%">
					...
					<c:forEach var="goods" items="${goodslist}">
						<tr>
							...
							<td>${goods.USER_ID}</td>
							<td>${goods.USER_CONTACT}</td>

							<td>
								<a class="link-update" href="admin_togoodsupdate?id=${goods.GOODS_ID}&page=${cpage}${search}">修改</a> 
								<a class="link-del" href="javascript:Delete('你确定要删除商品【${goods.GOODS_NAME }】吗?', '/testshop/manage/admin_dogoodsdelete?id=${goods.GOODS_ID}&page=${cpage}${search}')">删除</a>
							</td>
						</tr>
					</c:forEach>
