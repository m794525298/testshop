				...
				<table class="insert-tab" width="100%">
					<tbody>
						<tr>
							...
							<td><input class="common-text required" id="USERID" name="USERID" size="50" value="${cart.USER_ID }" type="text"></td>
						</tr>
						<tr>
							<th><i class="require-red">*</i>商品ID：</th>
							<td><input class="common-text required" id="GOODSID" name="GOODSID" size="50" value="${cart.GOODS_ID }" type="text"></td>
						</tr>
						<tr>
							<th><i class="require-red">*</i>商品数量：</th>
							<td><input class="common-text required" id="GOODSCOUNT" name="GOODSCOUNT" size="50" value="${cart.GOODS_COUNT }" type="text"></td>
						</tr>
