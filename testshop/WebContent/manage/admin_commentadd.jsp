			...
			<form action="/testshop/manage/admin_docommentadd" method="post"
				...
				<table class="insert-tab" width="100%">
					<tbody>
						...
						<tr>
							<th>被回复评论ID：</th>
							<td><input class="common-text required" id="COMMENTPARENT" name="COMMENTPARENT" size="50" value="" type="text"></td>
						</tr>
						<tr>
							<th><i class="require-red">*</i>评论内容：</th>
							<td><input class="common-text required" id="COMMENTCONTENT" name="COMMENTCONTENT" size="50" value="" type="text"></td>
						</tr>
