...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" id="img_show" src="img/temp/proDet.jpg"/>
                <div class="smallImg clearfix"><img id="img_1"  src="img/temp/proDet01.jpg"
                        ...
                        src="img/temp/proDet04.jpg" data-src="img/temp/proDet04_big.jpg"> <img id="img_5" 
                        src="img/temp/proDet04.jpg" data-src="img/temp/proDet04_big.jpg"></div>
            </div>
            <div class="fr intro">
                <div class="title"><h4  id="title">【最家】非洲菊仿真花干花</h4>
                    <p id="desc">【破损补寄】【适合放室内、卧室、书房、餐桌、办公室、客厅、电视柜等地方】【无理由退换货】【包邮】【白色现代简约花瓶】</p><span id="price">￥59.90</span></div>
                <div class="proIntro">
                  <h3>
						卖家信息
					</h3>
					
						<p>卖家名称&nbsp<a id="name">请问请问</a>
                ...
                <div class="btns clearfix"><a id="contactmerchant" href="#2"><p class="buy fl">联系商家</p></a><a href="#2"><p id="cart_but" class="cart fr">加入收藏夹</p></a></div>
            </div>
        </div>
    </div>
</div>
