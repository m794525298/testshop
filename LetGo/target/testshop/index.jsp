...
$(function(){
	...
	var url="MainPage";//这里是主页的功能，显示主页内容  把这个url改成主页
	...
	$.post(url,args,function(data){
		...
		$("#good_study_bot").empty();
			for(i=0;i<3;i++){
				...
				var href='detail.jsp?goodsID='+data.goods.goods_study[i].goodsID;
		...
		for(i=3;i<6;i++){
			...
			var href='detail.jsp?goodsID='+data.goods.goods_dailyuse[i].goodsID;
			var img=data.goods.goods_dailyuse[i].cover;
			var title=data.goods.goods_dailyuse[i].title;
			var price=data.goods.goods_dailyuse[i].price;
     ...
     " </dl>"+
		...
		$("#goods_eat_bot").empty();
			for(i=0;i<4;i++){
				...
				var href='detail.jsp?goodsID='+data.goods.goods_eat[i].goodsID;
...
/* 
	$.getJSON(url,args,function(data){
		...
		for(i=0;i<3;i++){
			...
			var href='goods_detail.jsp?goodsID='+data.goods_study[i].goodsID;
			var img=data.goods_study[i].cover;
