    ...
    <div class="wrapper clearfix">
        ...
        <div class="you fl"><h2>修改密码</h2>
            <form action="#" method="get" class="remima">
                <p><span>原密码：</span><input type="text" id="pwd1" name="userPassWord"/><span class="error">请输入原密码</span></p>            
                <p><span>新密码：</span><input type="text" id="pwd2" name="userPassWord"/><span class="error">请输入新密码</span></p>
                <p><span>重复新密码：</span><input type="text" id="pwd3" name="rePassWord"/><span class="error">请再次输入密码</span></p>
...
<script src="js/jquery.base64.js" type="text/javascript" charset="utf-8"></script>
	...
	$(function(){
		...
		var url="js/re_userAccount.js?userID="+id+"&oldPassword="+oldpassword+"&newPassword="+newpassword;
		var args ={"userID":id,
