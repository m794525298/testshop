				...
				<table class="result-tab" width="100%">
					...
					<c:forEach var="user" items="${userlist}">
						<tr>
							...
							<td>
								<a class="link-update" href="admin_touserupdate?id=${user.id}&page=${cpage}${search}">修改</a> 
								<a class="link-del" href="javascript:Delete('你确定要删除用户【${user.username }】吗?', '/testshop/manage/admin_douserdelete?id=${user.id}&page=${cpage}${search}')">删除</a>
							</td>
						</tr>
					</c:forEach>
