...
/**
 * Servlet implementation class ShowUserReplyController
 */
@WebServlet("/ShowUserReply")
public class ShowUserReplyController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private CommentService service;
	Map <String, String[]> map;

    public ShowUserReplyController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!map.containsKey("userID") || map.get("userID")[0].equals("")) {
			...
			json = service.getUserReply(userId, page);
		}
