				...
				<table class="result-tab" width="100%">
					...
					<c:forEach var="comment" items="${commentlist}">
						<tr>
							...
							<td>
								<a class="link-update" href="admin_tocommentupdate?id=${comment.id}&page=${cpage}${search}">修改</a> 
								<a class="link-del" href="javascript:Delete('你确定要删除评论【${comment.id }】吗?', '/testshop/manage/admin_docommentdelete?id=${comment.id}&page=${cpage}${search}')">删除</a>
							</td>
						</tr>
					</c:forEach>
