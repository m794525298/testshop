...
<div class="address mt">
    <div class="wrapper clearfix"><a href="index.jsp" class="fl">首页</a><span>/</span><a href="mymessage.jsp" class="on">我的交易</a><span>/</span><a
            href="mycomment.jsp" class="on">我的评论</a></div>
</div><!------------------------------Bott------------------------------>
<div class="Bott">
    <div class="wrapper clearfix">
        <div class="zuo fl">
        ...
        <div class="you fl">
            <div class="my clearfix" style="margin:40px 0 32px;"><h2 class="fl">我的商品评论</h2></div>
...
window.onload = function(){
	/* var url = "js/message.js"; */
	var url = "ShowUserGoodsComments"
									...
									.append(
							                ...
							                '<div class="word clearfix">'+
							                    '<ul class="fl clearfix">'+							                        
							                        '<li><a href="'+publisher_href+'" class="fl"><img src="'+icon+'"/></a>'+
							                        '<li style="color:#262626;font-size:15px;"><p>用户昵称：'+publisherName+'</p>'+
							                        '<p>时间：'+time+'</p>'+
							                        '<p><a  href="javascript:void(0);" onClick="del('+goodsID+')">点跳转至商品页面</a></p>'+
							                        '</li>'+							                        
							                    '</ul>'+
							                    '</div>'+
							            '</div>' 
...
$(function(){
	...
	var	href="mycomment.jsp?userID="+userID+"&page=1";
		window.location.href=href;
	})
	$("#last_page").click(function(){
		
		var	href="mycomment.jsp?userID="+userID+"&page="+storage.getItem('totalPage');
		window.location.href=href;
	})
	$("#previous_page").click(function(){
		...
		if(Number(storage.getItem('totalPage'))>page&&page>1){
			page=page-1;
			var	href="mycomment.jsp?userID="+userID+"&page="+page;}else{ var	href="mycomment.jsp?userID="+userID+"&page="+page;}
		window.location.href=href;
	})
	$("#next_page").click(function(){
		if(0<page&&page<Number(storage.getItem('totalPage'))){
			...
			page=page+1;
			var	href="mycomment.jsp?userID="+userID+"&page="+page;}else{
				var	href="mycomment.jsp?userID="+userID+"&page="+page;}
			window.location.href=href;
	})
